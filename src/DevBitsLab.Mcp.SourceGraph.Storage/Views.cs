        ...
        return new List<ViewDescriptor>
        {
            ...
            new(
                ...
                new List<ViewColumn>
                {
                    ...
                    new("end_line", "INTEGER", false, "1-based line containing the exclusive end boundary of the evidence range."),
                    new("end_column", "INTEGER", false, "1-based exclusive end column of the evidence range."),
