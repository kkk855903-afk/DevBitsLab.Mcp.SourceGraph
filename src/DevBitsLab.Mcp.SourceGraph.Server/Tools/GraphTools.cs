...
public static class GraphTools
{
    ...
    public static async Task<string> FindDefinitionAsync(
        IGraphStore store,
    ...
    public static async Task<string> ListSymbolsInFileAsync(
        IGraphStore store,
    ...
    public static async Task<string> ListCallersAsync(
        IGraphStore store,
    ...
    public static async Task<string> ListCalleesAsync(
        IGraphStore store,
    ...
    public static async Task<string> SearchSymbolsAsync(
        IGraphStore store,
    ...
    public static async Task<string> NeighborhoodAsync(
        IGraphStore store,
    ...
    public static async Task<string> ModuleSummaryAsync(
        IGraphStore store,
    ...
    public static async Task<string> ImpactOfChangeAsync(
        IGraphStore store,
        [Description("Symbol name or FQN")] string symbol,
    ...
    public static async Task<string> GraphStatsAsync(IGraphStore store, CancellationToken ct = default)
    {
